...
<form method="post" class="mb-5" action="<?= base_url(); ?>billing_pemeriksaan/tambah">
    <input type="hidden" name="kd_billing_periksa" value="<?= $kd_billing_periksa; ?>">
